...
if __name__ == '__main__':
    ...
    # compressor, decompressor = decompressor_trainer.train()
    ...
    # stepper_trainer = StepperTrainer(dataset, compressor)
    # stepper = stepper_trainer.train()
    ...
    # projector = projector_trainer.train()
